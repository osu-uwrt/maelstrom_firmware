...
module ddr3_interface_0002 (
	...
	altera_mem_if_hard_memory_controller_top_cyclonev #(
		...
		.AVL_DATA_WIDTH                          (32),
		.AVL_SIZE_WIDTH                          (8),
		.AVL_DATA_WIDTH_PORT_0                   (128),
		.AVL_ADDR_WIDTH_PORT_0                   (25),
		.AVL_NUM_SYMBOLS_PORT_0                  (16),
		.LSB_WFIFO_PORT_0                        (0),
		.MSB_WFIFO_PORT_0                        (1),
		.LSB_RFIFO_PORT_0                        (0),
		.MSB_RFIFO_PORT_0                        (1),
		...
		.mp_cmd_clk_1            (mp_cmd_clk_0_clk),                   //       mp_cmd_clk_1.clk
		.mp_cmd_reset_n_1        (mp_cmd_reset_n_0_reset_n),           //   mp_cmd_reset_n_1.reset_n
		...
		.avl_size_1              (8'b00000000),                        //        (terminated)
		...
		.avl_size_3              (8'b00000000),                        //        (terminated)
		...
		.avl_size_4              (8'b00000000),                        //        (terminated)
		...
		.avl_size_5              (8'b00000000),                        //        (terminated)
	...
	ddr3_interface_mm_interconnect_1 mm_interconnect_1 (
