...
module ddr3_interface_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (23552),
		.INIT_FILE        ("ddr3_interface_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ddr3_interface_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	ddr3_interface_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
